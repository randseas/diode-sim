    ...
    <main className="flex flex-col h-screen overflow-hidden select-none [*_*]:select-none [*_*]:user-select-none bg-[#181818] text-[#cccccc]">
      ...
      <div className="flex flex-1">
        ...
        <Aside
          ...
          scrollColors={scrollColors}
          colorContainerRef={colorContainerRef}
          checkScrollLimits={checkScrollLimits}
          ...
          MAX_TIMELINE_HISTORY={MAX_TIMELINE_HISTORY}
        />
        <main
              ...
              {elements.map((el: Element) => {
                ...
                return (
                  ...
                  >
                    ...
                    <el.renderIcon
                      el={el}
                      isDragging={el.ui?.isDragging || false}
                      isHovered={el.ui?.isHovered || false}
                    />
                    <text
                      textAnchor="middle"
                      y="-5"
      ...
      <footer className="h-[22.5px] border-t border-[#2b2b2b] bg-[#181818] text-[11px] flex items-center text-white"></footer>
    </main>
  );
}
